		...
		<h2>Book Product</h2>
			...
			<div class="row">
				...
				<div class="col-md-12">
						...
						<input class="form-control" required="required" type="number" id="PPRICE" value="{{$product->Price}}" readonly/>
					</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
				...
				<div class="col-md-12">
						...
						<input class="form-control" required="required" type="number" name="price" id="TOTAL" readonly/>
					</div>
					</div>                               
			</div>		
			...
			<div class="row">
				<div class="col-md-12">
					<p><button type="submit" name="upload" value="{{$product->id}}" class="btn btn-primary">Book Now</button></p>
				</div>
			</div>
			</form>						
