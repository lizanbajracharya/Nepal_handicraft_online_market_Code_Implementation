...
<div id="page">
    ...
    <div class="row" style="margin-left:35%;">
					...
					<h2>Billing Details</h2>
						<form method="POST" class="colorlib-form" action="{{route('bought.store',Auth::user()->id)}}" enctype="multipart/form-data">
                            @csrf
		              	...
		              	<div class="row">
								...
								<div class="col-md-12">
                                    ...
                                    <input type="text" name="id" class="form-control" disabled value="<?php $product=App\Product::findorFail($booking->Productid) ?>{{$product->Productname}}">
			                  </div>
			               </div>
			               <div class="col-md-12">
									<div class="form-group">
                           ...
                           <div class="col-md-12">
									...
									<input class="form-control" required="required" name="price" type="number" id="price" value="<?php $product=App\Product::findorFail($booking->Productid) ?>{{$product->Price}}" readonly>
			                  </div>
							  </div>
							  <div class="col-md-12">
									<div class="form-group">
                                    <label for="pnname">Quantity</label>
                                    <input type="text" name="quantity" class="form-control" value="{{$booking->Quantity}}" id="QTY" onKeyUp="multiply()" onMouseUp="multiply()" onKeyDown="return false" readonly>
			                  </div>
			                 </div>
							 <div class="col-md-12">
						<div class="form-group">
						<label for="price">Total</label>
						<input class="form-control" required="required" type="number" name="TOTAL" value="{{$booking->Price}}" readonly/>
					</div>
					</div>   
						   <div class="col-md-12">
									<div class="form-group">
