			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					...
				   					<h2 class="bread"> <span>Product</span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="col-md-6 text-center">
							<h2><i class="icon-paperplane"></i>Recommend your needed category</h2>
						</div>
						<div class="col-md-6">
							<form class="form-inline qbstp-header-subscribe" method="POST" action="{{ route('requestd.store')}}">
							@csrf
								<div class="row">
									<div class="col-md-12 col-md-offset-0">
										<div class="form-group">
											<input type="text" class="form-control" id="email" name="name" placeholder="Recommend category">
											<button type="submit" name="Recommend" class="btn btn-primary">Recommend</button>
										</div>
									</div>
								</div>
							</form>
